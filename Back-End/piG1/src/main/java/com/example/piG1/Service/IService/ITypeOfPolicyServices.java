...
import com.example.piG1.Model.DTO.TypeOfPolicyDTO.ListTypeOfPolicyAddPoliciesDTO;
...
public interface ITypeOfPolicyServices extends  ICheckId<TypeOfPolicy> {
    ...
    //List<ListTypeOfPolicyAddPoliciesDTO> listTypeOfPolicyAddPolicies(ListTypeOfPolicyAddPoliciesDTO listTypeOfPolicyAddPoliciesDTO);
